          ...
          <div className="space-y-5">
            {experience.map(exp => (
              <div key={exp.id}>
                ...
                <ul className="mt-2 text-sm text-black list-disc ltr:pl-4 rtl:pr-4 space-y-1">
          ...
          <div className="space-y-4">
            {education.map(edu => (
              <div key={edu.id}>
                ...
                <p className="text-sm font-medium text-black mt-0.5">{edu.institution}{edu.city ? `, ${edu.city}` : ''}</p>
              </div>
            ))}
          </div>
        </section>
