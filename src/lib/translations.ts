...
export const translations: Record<LanguageOption, Record<string, string>> = {
  en: {
    ...
    executive: 'Executive - Minimal Grid',
    tech: 'Tech - Developer Classic',
  ...
  fr: {
    ...
    misc: 'Divers - Style 1',
    'misc-2': 'Divers - Style 2',
    executive: 'Exécutif - Grille Minimale',
    tech: 'Tech - Classique Développeur',
    compact: 'Professionnel Compact',
    editorial: 'Éditorial - Créatif',
    corporate: 'Corporatif - Exécutif',
    // Form Sections
  ...
  ar: {
    ...
    misc: 'متنوع - نمط 1',
    'misc-2': 'متنوع - نمط 2',
    executive: 'تنفيذي - شبكة بسيطة',
    tech: 'تقني - كلاسيكي مطور',
    compact: 'احترافي مضغوط',
    editorial: 'تحريري - إبداعي',
    corporate: 'شركات - تنفيذي',
    // Form Sections
